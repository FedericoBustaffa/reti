...
class Dropbox2 extends Dropbox {

	/**
	 * Attende che il buffer contenga un numero, poi lo recupera e lo ritorna
	 *
	 * @param e indica l'interesse a consumare un numero pari o dispari se e == True
	 *          il numero contenuto è pari, altrimenti è dispari
	 * @return numero consumato
	 */
	@Override
	public synchronized int take(boolean e) {
		/*
		 * La seguente espressione equivale a: if (e == true) { s = "Pari" } else { s =
		 * "Dispari }
		 */
