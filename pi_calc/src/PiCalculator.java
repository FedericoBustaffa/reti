...
public class PiCalculator implements Runnable {
	...
	public void run() {
		...
		/*
		 * Prendo il valore assoluto poiché la serie alterna valori maggiori a valori
		 * minori di Math.PI
		 * dunque la sottrazione in certi casi avrebbe valore negativo e farebbe
		 * terminare scorrettamente il calcolo.
		 * Le condizioni di uscita dal ciclo sono il raggiungimento della precisione
		 * richiesta oppure l'interruzione del thread.
